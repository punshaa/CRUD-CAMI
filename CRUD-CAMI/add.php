    ...
    if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] == UPLOAD_ERR_OK) {
      ...
      if (in_array($extension, $allowed_types)) {
        ...
        if (move_uploaded_file($tmp, "uploads/$imagen_nueva")) {
          ...
          $stmt->bind_param("sssss", $titulo, $descripcion, $url_github, $url_produccion, $imagen_nueva);
          
          if ($stmt->execute()) {
            $success_message = "Proyecto agregado exitosamente.";
            // Limpiar campos después del éxito
            $titulo = $descripcion = $url_github = $url_produccion = '';
          } else {
            $error_message = "Error al guardar el proyecto en la base de datos.";
          }
        } else {
      ...
      $error_message = "Por favor selecciona una imagen para el proyecto.";
    }
  }
}
?>
...
<head>
    ...
    <title>Agregar Proyecto - Portafolio Camila</title>
    <!-- Bootstrap CSS 5.3.3 -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <div class="container">
            ...
            <div class="ms-auto">
                <a href="index.php" class="btn btn-new-project">
                ...
                <div class="col-lg-8">
                    <div class="animate-fade-in">
                        ...
                        <p class="page-subtitle">
                            Comparte tu nuevo proyecto con el mundo
                        </p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="file" 
                                       ...
                                       required>
                                <div class="invalid-feedback">
                                    Por favor selecciona una imagen para tu proyecto.
                                </div>
                                <div class="form-text">
                                    <small class="text-muted">
